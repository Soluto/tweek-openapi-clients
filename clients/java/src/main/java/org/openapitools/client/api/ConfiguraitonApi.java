...
public class ConfiguraitonApi {
     ...
     */
    public okhttp3.Call getValueCall(String keyName, Map<String, String> params, List<String> $include, Boolean $flatten, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private okhttp3.Call getValueValidateBeforeCall(String keyName, Map<String, String> params, List<String> $include, Boolean $flatten, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        okhttp3.Call call = getValueCall(keyName, params, $include, $flatten, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<Void> getValueWithHttpInfo(String keyName, Map<String, String> params, List<String> $include, Boolean $flatten) throws ApiException {
        okhttp3.Call call = getValueValidateBeforeCall(keyName, params, $include, $flatten, null, null);
     ...
     */
    public okhttp3.Call getValueAsync(String keyName, Map<String, String> params, List<String> $include, Boolean $flatten, final ApiCallback<Void> callback) throws ApiException {
        ...
        okhttp3.Call call = getValueValidateBeforeCall(keyName, params, $include, $flatten, progressListener, progressRequestListener);
